...
PPCG_OPTIONS=--no-shared-memory --no-private-memory -D__PENCIL__ --target=opencl --sizes="{kernel[i]->block[16,16]}" -I$(PENCIL_HEADERS) --opencl-include-file="$(PENCIL_HEADERS)/pencil_opencl.h" --isl-ast-always-print-block
